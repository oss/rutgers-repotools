...
class Controller extends CI_Base {
	...
	{	
		...
		// Added by Orcan Ogetbil
		// We need this information on each page. So let's put it here.
		$obj =& get_instance();
		$this->title = $obj->config->item('site_title');
	 ...
	 * @return	void
	 */
	function _ci_init_database($params = '', $return = FALSE, $active_record = FALSE, $centos_version='')
	{
		...
		{
			include(APPPATH.'config/database' . $centos_version . EXT);
